...
function UpdateUser() {
  ...
  const [avatar, setAvatar] = useState("/assets/img/boy.png");
  ...
  const getUser = async () => {
    return await UserApi.showUser(params.id)
      .then((response) => {
        ...
        setSelectedRole(response.data.user.role.id);
      })
  ...
  useEffect(() => {
    ...
    dispatch(sub_menu("Modifiier un utilisateur"));
  ...
  function handleSubmit(e) {
    ...
    UserApi.updateUser(params.id, formData)
      .then((response) => {
