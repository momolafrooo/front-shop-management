...
function UpdateShop() {
  ...
  useEffect(() => {
    ...
    dispatch(sub_menu("Modifier une boutique"));
    dispatch(expand_area("Boutiques"));

    const [body] = document.getElementsByTagName("body");
    const dropify = document.createElement("script");
    ...
    dropify.type = "text/javascript";
    dropify.src = "/plugins/dropify/dropify.min.js";
    body.appendChild(dropify);
  ...
  function handleSubmit(e) {
    ...
    // console.log(form_data.getAll("logo"));
    ShopApi.updateShop(form_data, params.id)
      .then((response) => {
